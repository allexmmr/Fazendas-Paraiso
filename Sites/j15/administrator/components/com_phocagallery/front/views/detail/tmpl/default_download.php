...
if ($this->tmpl['backbutton'] != '') {
	...
	echo '<tr><td align="left"><a title="'. JText::_('Image Download').'" href="'. JRoute::_('index.php?option=com_phocagallery&view=detail&catid='.$this->item->catslug.'&id='.$this->item->slug.'&phocadownload=2'.'&Itemid='. JRequest::getVar('Itemid', 1, 'get', 'int') ).'">'.JText::_('Image Download').'</a></td><td>&nbsp;</td>';
