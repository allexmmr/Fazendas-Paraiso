<div class="rb-items clearfix">
	...
	<div class="rb-item" id="select_text_<?php echo $key;?>">
		<input id="text_<?php echo $key;?>" class="rb-color" name="text_<?php echo $key;?>" type="text" size="13" value="<?php echo $ztTools->getParamsValue($prefix, 'text', $key);?>" style="background-color:<?php echo $ztTools->getParamsValue($prefix, 'text', $key);?>" />
	</div>
