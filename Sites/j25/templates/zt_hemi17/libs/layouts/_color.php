<div class="rb-items clearfix">
	...
	<div class="rb-item" id="select_color_<?php echo $key;?>">
		<input id="color_<?php echo $key;?>" class="rb-color" name="color_<?php echo $key;?>" type="text" size="13" value="<?php echo $ztTools->getParamsValue($prefix, 'color', $key);?>" style="background-color:<?php echo $ztTools->getParamsValue($prefix, 'color', $key);?>" />
	</div>
