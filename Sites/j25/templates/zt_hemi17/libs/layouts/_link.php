<div class="rb-items clearfix">
	...
	<div class="rb-item" id="select_link_<?php echo $key;?>">
		<input id="link_<?php echo $key;?>" class="rb-color" name="link_<?php echo $key;?>" type="text" size="13" value="<?php echo $ztTools->getParamsValue($prefix, 'link', $key);?>" style="background-color:<?php echo $ztTools->getParamsValue($prefix, 'link', $key);?>" />
	</div>
