...
function loadResults(data_ageent,ag_index) {
  ...
  if(ageent_go[ag_index]["mod_nicepoll"]) {
    ...
    results_html = results_html+"</table><p class='total'>"+ageent_go[ag_index]["ag_total_votes"]+": <b>"+total_votes+"</b><br /><br />"+yourealback+"<br /><a href='"+ageent_go[ag_index]["full_url_nicepoll"]+"' title='"+ageent_go[ag_index]["ag_all_poll"]+"' class='polls'>"+ageent_go[ag_index]["ag_all_poll"]+"</a></p></div>\n";
     } else {
    results_html = results_html+"</table><p class='total'><a href='"+ageent_go[ag_index]["full_url_nicepollfull_url_nicepoll"]+"' title='"+ageent_go[ag_index]["ag_all_poll"]+"' class='polls'>"+ageent_go[ag_index]["ag_all_poll"]+"</a>"+yourealback+"</p></div>\n";
     ...
     if(ageent_go[ag_index]["ag_total_votes"].length!=0) { 
         results_html = results_html+"</table><p class='total'>"+ageent_go[ag_index]["ag_total_votes"]+": <b>"+total_votes+"</b><br /><br />"+yourealback+"</p></div>\n";
     } else {
