...
<div class="ageent_main_only<?php echo $GLOBALS["copy"]." ".$sufics_varibal?>" >
    ...
    <table cellpadding="0" cellspacing="0" class="zobel">
      <tr>
        ...
        <td><input type="submit" name="option" value="<?php echo JText::_('RESULTS'); ?>" class="nicepollresult button" onclick="document.location.href='<?php echo JRoute::_("index.php?option=com_niceajaxpoll"); ?>'" /></td>
      </tr>
