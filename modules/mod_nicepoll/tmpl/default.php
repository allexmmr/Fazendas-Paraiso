...
<div class="ageent_main_only<?php echo $GLOBALS["copy"]." ".$sufics_varibal?>" >
    ...
    <?php        
       foreach ($options as $row) {                  
           $class="";
           if($template_nice_list==2) $class='class="stylednice"';
             echo "<div class='two_input'>
                 <table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" >
                    <tr>
                        <td><input type=\"radio\" value=\"".$row->id."\" name=\"voteid\" id=\"nice_".$row->id."\" ".$class." /></td>
    ...
    <table cellpadding="0" cellspacing="0" class="zobel">
      <tr>
        ...
        <td><input type="submit" name="option" value="<?php echo JText::_('RESULTS'); ?>" class="nicepollresult button" onclick="document.location.href='<?php echo JRoute::_("index.php?option=com_poll&id=$poll->alias".$poll->id); ?>'" /></td>
      </tr>
