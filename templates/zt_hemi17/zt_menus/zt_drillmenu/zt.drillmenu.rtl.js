function drilldownmenu(setting){
	this.sublevelarrow={src:'templates/zt_hemi17/zt_menus/zt_drillmenu/images/leftarrow.gif', width:'5px', top:'3px', left:'6px'} //full URL to image used to indicate there's a sub level
	this.breadcrumbarrow='templates/zt_hemi17/zt_menus/zt_drillmenu/images/leftarrow.gif' //full URL to image separating breadcrumb links (if it's defined)
	this.loadingimage='templates/zt_hemi17/zt_menus/zt_drillmenu/images/loader.gif' //full URL to 'loading' image, if menu is loaded via Ajax
	...
	this.backarrow='templates/zt_hemi17/zt_menus/zt_drillmenu/images/right.gif' //full URL to image added in front of back LI 
